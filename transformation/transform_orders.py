...
from pyspark.sql.functions import (col, date_diff, to_timestamp, round, avg, count, sum)
...
df = df.withColumn("delivery_time_days", date_diff(col("order_delivered_customer_date"), col("order_purchase_timestamp")))
